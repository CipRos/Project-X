...
const targChan = message.guild.channels.find(c => c.id == "667870313329066000") || null; // find the targeted channel
const messageid = targchan.fetchMessages("668445132735119374")
